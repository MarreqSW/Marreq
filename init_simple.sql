-- =============================================================================
-- ReqMan Database Initialization Script (Simplified)
-- =============================================================================
...
INSERT INTO verification (verification_name, verification_description, project_id) VALUES
    ...
    ('Analysis', 'Verification using models and calculations', 1),
    ('Demonstration', 'Manipulation of the product as intended', 1),
...
INSERT INTO requirements (req_title, req_description, req_reference, req_category, req_applicability, req_current_status, req_verification_method, req_author, req_reviewer, req_parent, req_link, req_creation_date, req_update_date, req_deadline_date, project_id) VALUES
    ...
    ('REQ-ACS-001', 'The satellite shall maintain pointing accuracy of ±0.1 degrees in all axes', 'REQ-ACS-001', 3, 1, 2, 1, 1, 2, 0, '', '2024-01-17', '2024-01-17', '2024-06-15', 1),
