...
mod document_builder_tests {
    use marreq_core::models::DecoratedRequirement;
    use marreq_core::services::semantic_search::{build_embedding_document, compute_content_hash};
...
mod embedding_provider_tests {
    use marreq_core::services::semantic_search::{EmbeddingProvider, MockEmbeddingProvider};
