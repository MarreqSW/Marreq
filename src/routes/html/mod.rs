...
pub fn routes() -> Vec<Route> {
    routes![
        ...
        applicability::show_applicability,
        applicability::new_applicability,
        applicability::post_applicability,
        applicability::get_edit_applicability,
        applicability::post_edit_applicability,
        applicability::delete_applicability_route,
